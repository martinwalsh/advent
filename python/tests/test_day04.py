from day04 import part1, part2, analyze
...
def test_example_is_guard_10_on_the_24th_minute():
    guards = analyze(EXAMPLE1)
    assert list(guards.keys()) == [10, 99]
    assert guards[10][24] == 2
